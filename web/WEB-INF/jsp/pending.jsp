<%--
    Document   : prendingPosts
    Created on : 25 janv. 2018, 22:43:02
    Author     : Mohamed
--%>
        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                ...
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="#">${user.getUser_Firstname()} ${user.getUser_Lastname()}</a>
                    </li>
            ...
            <div class="row">
                <div class="col-lg-11">
                    ...
                    <div class="mb-0 mt-4">
                        <i class="fa fa-newspaper-o"></i>  My Wall</div>
                    <hr class="mt-2">
                    <div class="">
                        <c:forEach items="${posts}" var="post">
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body py-2 small">
                                    ${post.getPost_Likes()}&nbsp;<a class="mr-3 d-inline-block" href="like?postId=${post.getPost_ID()}&l=0">
                                        <i class="fa fa-fw fa-thumbs-up"></i>Like</a>
                                    ${post.getPost_Dislikes()}&nbsp;<a class="mr-3 d-inline-block" href="dislike?postId=${post.getPost_ID()}&l=0">
